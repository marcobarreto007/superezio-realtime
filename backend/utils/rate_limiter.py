...
# Limites padrão
rate_limiter.add_limit("chat", max_requests=30, window_seconds=60)  # 30 req/min
rate_limiter.add_limit("chat_stream", max_requests=10, window_seconds=60)  # 10 req/min
rate_limiter.add_limit("tools", max_requests=100, window_seconds=60)  # 100 req/min
