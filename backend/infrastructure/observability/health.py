...
Moved from backend/middleware/health_check.py to infrastructure/observability/
"""
import time
import torch
...
from infrastructure.models.registry import LOCAL_MODEL_DIR
from infrastructure.config.settings import get_settings


settings = get_settings()
DEVICE = settings.device if settings.device == "cuda" and torch.cuda.is_available() else "cpu"
